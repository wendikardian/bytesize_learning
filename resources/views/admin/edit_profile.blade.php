    ...
    <div class="flex-col w-full">
        ...
        <div class="flex justify-between items-center bg-gray-100 rounded-2xl p-6 mb-6 w-full">
            <div class="flex w-full">
                <form action="{{ route('admin.updateProfile') }}" method="POST" enctype="multipart/form-data" class="w-full flex">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex w-full justify-around"
                            ...
                            <button>
                                <a href="/admin/edit/password" class="btn btn-sm rounded-lg normal-case text-black shadow-lg">Edit Password</a>
                            </button>
                        </div>
                </form>
            </div>
