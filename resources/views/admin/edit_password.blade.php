    ...
    <div class="flex-col w-full">
        ...
        <div class="flex justify-between items-center bg-gray-100 rounded-2xl p-6 mb-6 w-full">
            <div class="flex w-full">
                <form action="{{ route('admin.updatePassword') }}" method="POST" class="w-full flex flex-col">
                @csrf
                @method('PUT')
                    <div class="w-full mb-4">
                    ...
                    <div class="flex w-full justify-around" style="justify-content: space-between;">
                        ...
                        <button>
                            <a href="/admin/profile" class="btn btn-sm rounded-lg normal-case text-black shadow-lg">Cancel</a>
                        </button>
                    </div>
                </form>
            </div>
