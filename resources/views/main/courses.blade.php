...
<div class="flex flex-col p-6 mt-4 rounded-3xl bg-gray-100 ">
    <div class="flex flex-col justify-center items-center ">
      ...
      <div class="form-control mb-8">
        <form action="{{ route('courses.index') }}" method="GET" class="input-group">
          <input type="text" name="search" placeholder="Search…" class="input input-bordered" value="{{ request()->query('search') }}" />
